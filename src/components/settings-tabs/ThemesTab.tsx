...
function ThemesTab() {
    return (<>
        ...
        <div className="themes-container">
            ...
            <div className="theme-button" style={{backgroundImage: "url(https://images.steamusercontent.com/ugc/2438013375536940927/D370DBF7BFC83ED36F783F08A598FFF3E71A1D61/?imw=5000&imh=5000&ima=fit&impolicy=Letterbox&imcolor=%23000000&letterbox=false)"}}>Cyberpunk</div>
            <div className="theme-button" style={{backgroundImage: "url(https://i.pinimg.com/originals/db/8d/5b/db8d5bf6928701fbfb9c576163964f9c.gif)"}}>Vaporwave</div>
            ...
            <div className="theme-button" style={{backgroundImage: "url(https://media4.giphy.com/media/v1.Y2lkPTZjMDliOTUyZzd3eWV0bG9qcjltZXdsZ3ljcjZvNHl6ZzRraHp2aWRmd3JjdXRlOSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3oEduYJ5WzNGsAadKU/source.gif)"}}>Forest</div>
